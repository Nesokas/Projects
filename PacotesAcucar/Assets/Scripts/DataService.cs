...
public class DataService {
	...
	{
#if UNITY_EDITOR
		_connection.DropTable<Colection>();
		_connection.DropTable<Pacote>();
#endif

		_connection.CreateTable<Colection>();
		_connection.CreateTable<Pacote>();
	}

	public void InsertPacote(int collection_id_num, int pacote_num)
	{
